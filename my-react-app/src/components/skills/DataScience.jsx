            ...
            <div className="skills_box">
                ...
                <div className="skills_group">
                    ...
                    <div className="skills_data">
                        <i class="bx bx-badge-check"></i>
                    <div>
                        <h3 className="skills_name"> Torch </h3>
                        <span className="skills_number"> 90% </span>
                    </div>
                    </div>
